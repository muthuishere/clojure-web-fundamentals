(ns moviesappv1.handler-test
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [moviesappv1.handler :refer :all]
    [moviesappv1.middleware.formats :as formats]
    [muuntaja.core :as m]
    [mount.core :as mount]))
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'moviesappv1.config/env
                 #'moviesappv1.handler/app-routes)
    (f)))
