(ns moviebookingappv5datomicgraphql.handler-test
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [moviebookingappv5datomicgraphql.handler :refer :all]
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'moviebookingappv5datomicgraphql.config/env
                 #'moviebookingappv5datomicgraphql.handler/app-routes)
    (f)))
