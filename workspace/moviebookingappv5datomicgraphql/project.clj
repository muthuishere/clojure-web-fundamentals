(defproject moviebookingappv5datomicgraphql "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot moviebookingappv5datomicgraphql.core
  ...
  {:uberjar {:omit-source true
             :aot :all
             :uberjar-name "moviebookingappv5datomicgraphql.jar"
